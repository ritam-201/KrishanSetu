...
connectDB()
  .then(async () => {
    ...
    try {
      ...
      console.error("⚠️ Admin seed initialization error:", error.message);
    }
  })
  .catch((error) => {
...
app.get("/api/farmer/profile", verifyToken, getFarmerProfile);

app.post("/api/queue/book", verifyToken, bookToken);

app.get("/api/audit-logs", verifyToken, getAuditLogs);
...
app.get("/api/admin/auth/sessions", verifyAdminToken, getAdminSessions);
...
app.get("/api/admin/dashboard", verifyAdminToken, getAdminDashboard);

app.get("/api/admin/farmers", verifyAdminToken, getAdminFarmers);

app.get("/api/admin/crop-bookings", verifyAdminToken, getAdminCropBookings);

app.post("/api/admin/crop-bookings", verifyAdminToken, createAdminCropBooking);

app.get("/api/admin/payments", verifyAdminToken, getPayments);

app.post("/api/admin/payments", verifyAdminToken, createPayment);
...
app.get("/api/admin/queue", verifyAdminToken, getAdminQueue);

app.get("/api/admin/reports", verifyAdminToken, getAdminReports);
