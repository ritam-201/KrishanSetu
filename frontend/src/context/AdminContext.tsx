...
const GOVERNMENT_TOKEN_KEY =
  'kisansetu_government_token';

const GOVERNMENT_USER_KEY =
  'kisansetu_government_user';
...
export const AdminAuthProvider: React.FC<{
  ...
  const [governmentToken, setGovernmentToken] =
    useState<string | null>(() => {
