...
export const Hero: React.FC = () => {
  ...
  /*
   * Find the active token belonging ONLY to the logged-in farmer.
   *
   * Valid statuses:
   * waiting
   * called
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -bottom-52 -left-40 h-125 w-125 rounded-full bg-lime-200/20 blur-[120px]" />
        ...
        <div className="grid min-h-[calc(100vh-72px)] items-center gap-12 py-12 lg:grid-cols-[0.92fr_1.08fr] lg:gap-16 lg:py-14">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <h1 className="text-[3.4rem] font-black leading-[0.98] tracking-[-0.055em] text-slate-950 sm:text-6xl lg:text-[5rem]">
              ...
              <span className="block bg-linerar-to-r from-emerald-700 via-green-600 to-lime-500 bg-clip-text text-transparent">
