    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="absolute left-[10%] right-[10%] top-10.5 hidden h-px bg-linear-to-r from-transparent via-emerald-200 to-transparent lg:block" />
...
>
                    ...
                    {/* Top accent */}
                    <div className="absolute left-6 right-6 top-0 h-1 rounded-b-full bg-linear-to-r from-emerald-400 to-lime-400 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
